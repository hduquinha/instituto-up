...
const FinalCtaSection = () => {
  ...
  return (
    <section className="relative bg-dark-section py-20 px-4 sm:px-6 overflow-hidden">
      ...
      <div
        className="relative z-10 container max-w-3xl mx-auto"
        data-aos="zoom-in-up"
      >
        <div className="bg-gradient-to-b from-[#1c1c1c] to-black rounded-2xl border border-gray-800 shadow-2xl shadow-black/50 overflow-hidden">
          <div className="p-6 sm:p-8 md:p-12 text-center">
            ...
            <p className="mt-2 text-lg text-turquoise">
          ...
          <div className="p-6 sm:p-8 md:p-12 border-t border-gray-800">
            ...
            <Button
              variant="cta"
              size="lg"
              className="w-full max-w-md mx-auto text-lg sm:text-xl font-bold py-6 sm:py-8 h-auto transition-all duration-300 shadow-[0_0_20px_#40E0D0] hover:shadow-[0_0_35px_#40E0D0]"
            >
