...
const FAQSection = () => {
  ...
  const faqs = [
    ...
    },
    {
      ...
      answer: "O evento acontece nos dias 15 e 16 de agosto de 2026 em São Paulo-SP, na Rua Abílio Soares, 245 – Bairro Paraíso. Horário: Sábado: 6:59h às 20:59h; Domingo: 8:59h às 18:59h. O programa é intensivo, desenvolvido para maximizar o aprendizado com intervalos estratégicos."
    },
    {
