...
const PricingSection = () => {
  const plans = [
    { name: "Acesso Essencial", price: "297", description: "Para quem quer dar o primeiro passo e ter acesso ao vivo à transformação.", features: ["Acesso aos 2 dias de treinamento ao vivo", "Material de apoio em PDF", "Acesso à comunidade de alunos"], cta: "Começar Agora", isRecommended: false },
    { name: "Plano UP", price: "497", description: "A experiência completa para absorver, rever e aplicar todo o conhecimento.", features: ["Tudo do plano Essencial, e mais:", "Acesso à gravação por 1 ano", "Sessão Bônus de Q&A em grupo", "Módulo extra: 'Produtividade Acelerada'"], cta: "Garantir Minha Vaga", isRecommended: true },
    { name: "Experiência Premium", price: "997", description: "Para quem busca maestria e acompanhamento individualizado.", features: ["Tudo do plano UP, e mais:", "Acesso VITALÍCIO às gravações", "1 Sessão de mentoria individual", "Acesso ao grupo Mastermind"], cta: "Aplicar para Premium", isRecommended: false },
  ];

  return (
    <section className="relative bg-black py-20 px-4 sm:px-6 overflow-hidden">
      <div className="absolute inset-0 flex justify-center items-center opacity-30"><div className="w-[1000px] h-[1000px] bg-turquoise/10 rounded-full blur-[150px]"></div></div>
