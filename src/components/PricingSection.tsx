  ...
  const plans = [
    {
      ...
      features: [
        "1 dia de imersão em comunicação e liderança (14h)",
        "Data: 25 de Outubro de 2025",
        "Local: Lito Palace Hotel - Registro-SP",
        "4 Pilares: Autoconhecimento, Reprogramação, Gestão Emocional e Liderança",
        "Técnicas avançadas de comunicação assertiva",
        "Ferramentas práticas de liderança e influência",
